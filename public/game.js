...
startGame.prototype = {
  preload: function() {
    ...
    game.load.image("startBtn", "assets/sprites/sprite_btn_start.png");
    game.load.image('instructionBtn', 'assets/sprites/sprite_btn_instructions.png');
    game.load.image('creditBtn', 'assets/sprites/sprite_btn_credits.png');
  },
  create: function(){
    ...
    startBtn = game.add.button(game.world.centerX - 130, 227, 'startBtn', function() {
      game.state.start("PlayGame");
    }, this, 2, 1, 0);
    startBtn.scale.setTo(0.65, 0.65);

    instructionBtn = game.add.button(game.world.centerX - 130, 288, 'instructionBtn', function() {
      game.state.start("InstructionScreen");
    }, this, 2, 1, 0);
    instructionBtn.scale.setTo(0.65, 0.65);

    creditBtn = game.add.button(game.world.centerX - 130, 348, 'creditBtn', function() {
